...
//
//
//         // if (JSON.parse(data[0]).status){
//         //     Done = JSON.parse(data[0]).data
//         // }
//         // if (JSON.parse(data[1]).status)
//         //     Rework = JSON.parse(data[1]).data
//         // if (JSON.parse(data[2]).status)
//         //     Pending = JSON.parse(data[2]).data
//         // if (JSON.parse(data[3]).status)
//         //     Assigned = JSON.parse(data[3]).data
//         // if (JSON.parse(data[4]).status)
//         //     Unassigned = JSON.parse(data[4]).data
//         //
